...
class Map {
    ...
    drawMap(world) {
        ...
        svg.selectAll('path').data(geojson.features).join("path").attr("id",(d)=>d.id).attr("d",geoPath).classed("boundary",true)
        ...
        svg.append('path').datum(graticule).attr("d",geoPath).attr("class","graticule");
        svg.append('path').datum(graticule.outline).attr("d",geoPath).attr("class","stroke");
    }
    ...
    updateHighlightClick(activeCountry) {
        ...
        this.clearHighlight();
        d3.select("#" + activeCountry).classed("selected-country", true);
    ...
    clearHighlight() {
        ...
        d3.select("#map-chart").selectAll("path").classed("selected-country", false);
    }
}
